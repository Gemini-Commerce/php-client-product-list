...
/**
 * ProductlistUpdateProductListRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductlistUpdateProductListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'productlistUpdateProductListRequest';
    ...
    protected static $setters = [
        ...
        'attributes_mask' => 'setAttributesMask'
    ];
    ...
    protected static $getters = [
        ...
        'attributes_mask' => 'getAttributesMask'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('attributes_mask', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets attributes_mask
     *
     * @return string|null
     */
    public function getAttributesMask()
    {
        return $this->container['attributes_mask'];
    }

    /**
     * Sets attributes_mask
     *
     * @param string|null $attributes_mask attributes_mask
     *
     * @return self
     */
    public function setAttributesMask($attributes_mask)
    {
        if (is_null($attributes_mask)) {
            throw new \InvalidArgumentException('non-nullable attributes_mask cannot be null');
        }
        $this->container['attributes_mask'] = $attributes_mask;
